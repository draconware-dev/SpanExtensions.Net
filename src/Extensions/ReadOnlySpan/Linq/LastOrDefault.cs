...
namespace SpanExtensions
{
    ...
    {
        /// <summary>
        /// Returns the last element in a <see cref="ReadOnlySpan{T}"/>, or a specified default value if the <see cref="ReadOnlySpan{T}"/> contains no elements..
        /// </summary>
        ...
        public static T LastOrDefault<T>(this ReadOnlySpan<T> source, T defaultValue)
        {
            if(source.IsEmpty)
            {
                return defaultValue;
        ...
        public static T LastOrDefault<T>(this ReadOnlySpan<T> source, Predicate<T> predicate, T defaultValue)
        {
        ...
        /// <summary>
        /// Returns the last element in a <see cref="ReadOnlySpan{T}"/> that satisfies a specified conditionor a default value if no such element is found.
        /// </summary>
        /// <typeparam name="T">The type of elements in <paramref name="source"/>.</typeparam>
        /// <param name="source">The <see cref="ReadOnlySpan{T}"/> to return the last element of.</param>
        /// <param name="predicate">A function to test each element for a condition.</param>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="predicate"/> is null.</exception> 
        public static T? LastOrDefault<T>(this ReadOnlySpan<T> source, Predicate<T> predicate)
        {
            if(predicate is null)
            {
                throw new ArgumentNullException(nameof(predicate));
