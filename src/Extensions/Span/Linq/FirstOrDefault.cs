...
namespace SpanExtensions
{
    ...
    {
        /// <summary>
        /// Returns the first element in a <see cref="Span{T}"/>, or a specified default value if the <see cref="Span{T}"/> contains no elements..
        /// </summary>
        ...
        {
            return ReadOnlySpanExtensions.FirstOrDefault(source, defaultValue);
        }
        ...
        public static T FirstOrDefault<T>(this Span<T> source, Predicate<T> predicate, T defaultValue)
        {
            return ReadOnlySpanExtensions.FirstOrDefault(source, predicate, defaultValue);
        }
        ...
        {
            return ReadOnlySpanExtensions.FirstOrDefault<T>(source);
        }

        /// <summary>
        /// Returns the first element in a <see cref="Span{T}"/> that satisfies a specified conditionor a default value if no such element is found.
        /// </summary>
        /// <typeparam name="T">The type of elements in <paramref name="source"/>.</typeparam>
        /// <param name="source">The <see cref="Span{T}"/> to return the first element of.</param>
        /// <param name="predicate">A function to test each element for a condition.</param>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="predicate"/> is null.</exception> 
        public static T? FirstOrDefault<T>(this Span<T> source, Predicate<T> predicate)
        {
            return ReadOnlySpanExtensions.FirstOrDefault(source, predicate);
        }
#elif NETSTANDARD2_1
