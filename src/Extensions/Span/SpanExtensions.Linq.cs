...
namespace SpanExtensions
{
    ...
    public static partial class SpanExtensions
    {
        ...
        /// <returns>A <see cref="Span{T}"/> that contains the elements from <paramref name="source"/> starting at the first element in the linear series that does not pass the specified <paramref name="condition" />.</returns>
