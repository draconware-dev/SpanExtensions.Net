...
namespace SpanExtensions.SourceGenerators
{
    ...
    {
        static readonly string @namespace = typeof(CopyGenerator).Namespace;
        static readonly AssemblyName assemblyName = typeof(CopyGenerator).Assembly.GetName();
        static readonly string generatedCodeAttribute = $@"global::System.CodeDom.Compiler.GeneratedCodeAttribute(""{assemblyName.Name}"", ""{assemblyName.Version}"")";

        const string generateCopyAttributeName = "GenerateCopyAttribute";
        static readonly string generateCopyAttributeFullName = $"{@namespace}.{generateCopyAttributeName}";
        ...
        static readonly char[] endLineChars = ['\r', '\n'];
        ...
        internal sealed class TypeDeclaration(string modifiers, string keyword, string name, string constraints) : IEquatable<TypeDeclaration>
        {
            ...
            {
                string type = $"{Modifiers} {Keyword} {Name}";
